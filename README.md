...
## Get Extension
[Download the Chrome extension here](https://chromewebstore.google.com/detail/reporuler/pbffgdgaelgacobpfgidjkpeoaljgpij)

## GitHub
Works for public repos. Private repos need a PAT (input PAT by clicking on the extension icon).
...
This extension will likely not be updated to include a GitLab integration in the future because it is unnecessary for repos you contribute to (GitLab already displays it) and usually does not work for repos you don't contribute to (GitLab requires project statistics to be set to public).
